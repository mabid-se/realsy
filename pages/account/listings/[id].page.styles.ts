...
export const singleListingPageStyles = {
    ...
    statusMarker: {
        ...
        position: "relative",
        clipPath:
            "polygon(0 0, 15px 50%, 0 100%, calc(100% - 15px) 100%, 100% 50%, calc(100% - 15px) 0)",
        ...
        "&.first": {
            clipPath:
                "polygon(0 0, 0 100%, calc(100% - 15px) 100%, 100% 50%, calc(100% - 15px) 0)",
        },
        "&.last": {
...
export const useSingleListingPageStyles = createUseStyles(
    singleListingPageStyles
);
