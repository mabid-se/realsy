...
class CreateListingPage2 extends React.Component {
    ...
    constructor(props) {
        ...
        const savedState =
            process.browser &&
            JSON.parse(
                localStorage.getItem(CreateListingPage2.LOCAL_STORAGE_STATE_KEY)
            );
        if (
            savedState &&
            !this.props.valuation.wasUnable &&
            savedState?.valuation?.wasUnable !== true
        ) {
            this.state = {
                ...savedState,
                loading: false,
    ...
    static async getInitialProps(context) {
        if (!process.browser) {
            ...
            context.res.writeHead(302, {
                Location: "/account/listings/create",
            });
            context.res.end();
            return null;
        }
        ...
        const step1State =
            process.browser &&
            JSON.parse(localStorage.getItem("create-listing-step-1-state"));
        const homeValuation =
            process.browser &&
            JSON.parse(localStorage.getItem("home-valuation"));
        ...
        return {
            ...
            microContent:
                microContent ?? CreateListingPage.defaultProps.microContent,
        };
    }
        ...
        const homeValuationResult = await Listings.getHomeValue(
            {
                ...
                city: step1State.inputs[
                    CreateListingPage.FORM_ELEMENTS.city.name
                ],
                state: step1State.inputs[
    ...
    async _handleSubmit(e) {
        ...
        localStorage.setItem(
            CreateListingPage2.LOCAL_STORAGE_STATE_KEY,
            JSON.stringify({
                ...this.state,
                estimatedHomeValue:
                    this.props.valuation.valuations?.default?.EMV,
            })
        );
                ...
                <div className={styles.wrapper}>
                    <div
                        ...
                        dangerouslySetInnerHTML={{
                            __html: this.props.microContent.page2_sidebar,
                        }}
                    />
                    <form onSubmit={this._handleSubmit} className={styles.form}>
                        ...
                        {this.props.valuation.wasUnable && (
                            <p>
                                We weren't able to valuate your home. You can
                                continue with your listing and a Realsy agent
                                ...
                                <div className={styles.inputs}>
                                    ...
                                    <label>
                                        ...
                                        <TextInput
                                            ...
                                            name={"squareFootage"}
                                            value={
                                                this.state.inputs.squareFootage
                                            }
                                            required
                                            inputProps={{
                                                "data-testid":
