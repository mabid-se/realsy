...
class CreateListingPage3 extends React.Component {
    ...
    async _handleSubmit(e) {
        ...
        let listing = JSON.parse(
            localStorage.getItem("create-listing-step-1-state")
        ).inputs;
        const step2State = JSON.parse(
            localStorage.getItem("create-listing-step-2-state")
        );
        ...
        listing.askingPrice =
            step2State.valuation.valuations?.general?.high ?? 100000;
        ...
        if (createResult.success) {
            ...
            setTimeout(
                () =>
                    Router.push(`/account/listings/${createResult.listing.id}`),
                400
            );
        } else {
            const errorMessage =
                createResult.errorCode === "duplicate-listing"
     ...
     */
    render() {
        const agentImageUrl = Uploads.getUploadFullUrl(
            this.props.defaultAgent.photo?.url
        );
                ...
                <div className={styles.wrapper}>
                    <div
                        ...
                        dangerouslySetInnerHTML={{
                            __html: this.props.microContent.page3_sidebar,
                        }}
                    />
                        ...
                        <div className={styles.formWrapper}>
                            ...
                            <div className={styles.inputs}>
                                <div>
                                    <h4>
                                        Your Availability{" "}
                                        {this.props.microContent
                                            .page3_availabilityPopup && (
                                            <ToolTip
                                                htmlContent={
                                                    this.props.microContent
                                                        .page3_availabilityPopup
