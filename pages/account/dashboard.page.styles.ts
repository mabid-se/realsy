...
export const dashboardPageStyles = {
    alert: {
        ...
        "&:hover": { boxShadow: "0 0 20px rgba(0, 0, 0, 0.3)", paddingTop: 25 },
        "&.hidden": { maxHeight: 0, padding: 0 },
        "& h3": { color: "#fff", marginBottom: 10 },
        "@media (min-width: 750px)": { marginTop: -50 },

        "& a": { "&:hover": { fontWeight: 200 } },
    },
    ...
    savingsCard: {
        ...
        "& div": {
            ...
            "&:nth-of-type(2)": {
                ...
                color: "#fff",
                "& span": {
                    "&:first-of-type": { borderColor: "#fff" },
                    "&:nth-of-type(2)": { color: "#fff", borderColor: "#fff" },
                },
            },
        },
    },
