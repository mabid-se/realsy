    ...
    return (
        <form
            onSubmit={async (e) => {
                ...
                if (email === "" || password === "") {
                    logger.debug(
                        "Not submitting register request. Email or password missing."
                    );
                    NotificationManager.error(
                        props.missingEmailOrPasswordError
                    );
                    return;
                }
                if (password !== passwordConfirm) {
                    logger.debug(
                        "Not submitting register request. Password confirmation does not match"
                    );
